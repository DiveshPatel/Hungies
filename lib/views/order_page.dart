                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget>[
                                Text("Burrito Con Frutos Del Mar",
                                    style: TextStyle(color: Colors.white)),
                                OrderItem()
                              ],
                            )
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget>[
                                Text("Enchilada bandera Mexicana",
                                    style: TextStyle(color: Colors.white)),
                                OrderItem()
                              ],
                            )
